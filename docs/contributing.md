...
| `interaction-cooldown.test.js` | Guild slash-command cooldown bookkeeping and safe expiry |
...
| `economy-account-delete.test.js` | Account deletion does not rely on document-shaped `deleteMany()` |
