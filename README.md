...
Developer and operator notes live in [`docs/engineering-guide.md`](docs/engineering-guide.md). Permission gates, eval sandboxing, and ticket/setup authorization are in [`docs/security.md`](docs/security.md).
